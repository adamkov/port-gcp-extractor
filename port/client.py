...
class PortClient:
    ...
    def get_blueprints(self):
        return requests.get(f'{self.api_url}/blueprints',
                      headers=self.headers,)

    def update_entity(self, blueprint_id, entity):
        return requests.post(f'{self.api_url}/blueprints/{blueprint_id}/entities',
                            headers=self.headers,
                             json=entity)
